...
if __name__ == "__main__":
    ...
    class create_model(Network):
        ...
        def __init__(self, rng):
            ...
            Network.__init__(self, n_hidden_layer = n_hidden_layer, BN_LSTM = BN_LSTM, length = length)
            
            print ("LSTM layer:")
            self.layer.append(LSTM(rng = rng, n_inputs = n_inputs, n_units = n_units, initial_gamma = initial_gamma, 
                initial_beta = initial_beta, length = length, batch_size = batch_size, BN = BN_LSTM, BN_epsilon=BN_epsilon,
